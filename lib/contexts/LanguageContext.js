...
export const translations = {
  ...
  ar: {
    ...
    everyItemVerified: 'كل منتج تم التحقق من أصالته وجودته الممتازة',
    fastDelivery: 'توصيل سريع',
    quickSecureDelivery: 'توصيل سريع وآمن إلى موقعك',
    rareFinds: 'قطع نادرة',
    exclusiveLimited: 'مقتنيات حصرية ومحدودة الإصدار',
