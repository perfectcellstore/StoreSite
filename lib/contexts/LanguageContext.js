...
export const translations = {
  ...
  ar: {
    ...
    // Menu & Effects
    clickEffects: 'تأثيرات النقر',
    on: 'مفعل',
    off: 'معطل',
    secret: '??? السر ???',
    
    // Sword Easter Egg
    theLegendarySword: 'السيف الأسطوري',
    pullTheSword: 'اسحب السيف! ⚔️',
    pulling: 'جاري السحب...',
    onlyTheWorthy: 'فقط الجديرون يمكنهم سحب هذا السيف...',
    youAreWorthy: '⚔️ أنت جدير! ⚔️',
    legendaryBladeRecognizes: 'السيف الأسطوري يعترف بروحك!',
    ancientPowerFlows: 'تتدفق القوة القديمة من خلالك. هذا السيف المقدس، المصنوع من نيران التطور، قد اختار بطله. مع هذا السيف تأتي مسؤولية كبيرة ومكافآت أكبر.',
    yourLegendaryReward: '🎁 مكافأتك الأسطورية:',
    twentyPercentOff: '20% خصم',
    sacredPromoCode: 'رمز الترويج المقدس:',
    copiedToInventory: '✓ تم النسخ إلى مخزونك!',
    useCodeAtCheckout: '⚡ استخدم هذا الرمز عند الدفع لفتح خصمك',
    ...
    promoCodeApplied: 'تم تطبيق رمز الترويج! 🎉',
    promoCodeNotValid: 'رمز الترويج غير صالح',
    promoCodeRemoved: 'تم إزالة رمز الترويج',
    ourStory: 'قصتنا',
    ourMission: 'مهمتنا',
