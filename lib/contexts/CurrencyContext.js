  ...
  const convertPrice = useCallback((priceInUSD) => {
    switch (currency) {
      case 'IQD':
        ...
        return roundIQDPrice(priceInUSD * USD_TO_IQD_RATE);
      case 'EUR':
        // Round to .49 or .99
        return roundToNineOrFortyNine(priceInUSD * USD_TO_EUR_RATE);
      default:
        // USD - Round to .49 or .99
        return roundToNineOrFortyNine(priceInUSD);
    }
  }, [currency]);
