 ...
 * IMPORTANT: Using NEW file path /music/calm_lofi_v2.mp3 (NOT background.mp3)
 */
async function loadBackgroundMusic() {
  // Force reload - reset loaded state for new music file
  const MUSIC_FILE_PATH = '/music/calm_lofi_v2.mp3';
  
  console.log('[AudioManager] 🎵 Loading NEW music file:', MUSIC_FILE_PATH);
  console.log('[AudioManager] ⚠️ OLD file (background.mp3) has been DELETED');
  ...
  if (buffer) {
    musicBuffer = buffer;
    isMusicLoaded = true;
    console.log('[AudioManager] ✅ Successfully loaded NEW music:', MUSIC_FILE_PATH);
    return true;
  }
