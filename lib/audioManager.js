...
/**
 * Public API: Play click sound (SYNCHRONOUS & NON-BLOCKING)
 * Volume: 0.5 (balanced with background music at 0.15-0.25)
 * 
 * CRITICAL: This is fire-and-forget. It NEVER blocks the UI.
 * Returns immediately, audio plays asynchronously in background.
 */
...
/**
 * Public API: Play robot sound (SYNCHRONOUS & NON-BLOCKING)
